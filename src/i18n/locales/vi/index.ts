const vi = {
  Common: {
    ...
    Delete: 'Xóa {{name}}',
    ConfirmDelete: 'Bạn chắc chắn muốn xóa {{name}} này?',
    Cancel: 'Hủy',
    Confirm: 'Xác nhận',
    Search: 'Tìm kiếm',
    Upload: 'Tải lên',
  ...
  Dashboard: {
    ...
    Description:
      'Khám phá những tính năng vượt trội và nâng tầm hiệu suất làm việc với các giải pháp sáng tạo.',
    GetStarted: 'Bắt đầu',
  ...
  Fields: {
    ...
    User: 'người dùng',
    User2: 'người dùng',
    UserRoles: 'vai trò của người dùng',
    FullName: 'Họ và tên',
    Email: 'Email',
    Index: 'STT',
    Description: 'Mô tả',
  ...
  Validation: {
    ...
    Mismatch: 'Tài khoản hoặc mật khẩu không đúng!',
